...
export class StorageService {
    ...
    static setAccessToken = (token: string) => localStorage.setItem('token', token);
    static setExpire = (expire: string) => localStorage.setItem("expire", expire);
    static setUserName = (userName: string) => localStorage.setItem('user-name', userName);
    static setRights = (rights: string[]) => localStorage.setItem("right", join(rights, ','));
