...
namespace Snippet.Micro.RBAC.Controllers.RBAC
{
    ...
    public class ElementController : ControllerBase
    {
        ...
        /// </summary>
        [HttpPost]
        [ProducesResponseType(typeof(GetElementOutputModel), 200)]
            ...
            [FromServices] IMapper mapper)
        {
            ...
            return CommonResultExtension.SuccessResult(mapper.Map<GetElementOutputModel>(element));
        }
        ...
        /// </summary>
        [HttpPost]
        [ProducesResponseType(typeof(List<GetElementTreeOutputModel>), 200)]
            ...
            [FromServices] IMapper mapper)
        {
            ...
            return CommonResultExtension.Success(MessageConstant.ELEMENT_INFO_0001);
        }
        ...
        public async Task<CommonResult> DeleteElement([FromBody] IdInputModel<int> inputModel)
        {
            ...
            await _dbContext.SaveChangesAsync();
            return CommonResultExtension.Success(MessageConstant.ELEMENT_INFO_0002);
        }
            ...
            [FromServices] IMapper mapper)
        {
            ...
            await _dbContext.SaveChangesAsync();
            return CommonResultExtension.Success(MessageConstant.ELEMENT_INFO_0003);
        }
            ...
            List<Element> childElements)
        {
            ...
            foreach (var node in outputModels)
            {
                ...
                var childs = (from e in elements
                              ...
                              where et.Length == 1 && et.Ancestor == node.Id
                              select e).ToList();
