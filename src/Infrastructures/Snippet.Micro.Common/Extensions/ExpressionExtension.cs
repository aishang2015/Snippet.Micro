...
namespace Snippet.Micro.Common.Extensions
{
    public static class ExpressionExtension
    {
        ...
        /// 与
        /// </summary>
        public static Expression<Func<T, bool>> AndAll<T>(this Expression<Func<T, bool>> expression, Expression<Func<T, bool>> andExpression)
        {
            var invokedExpr = Expression.Invoke(andExpression, expression.Parameters.Cast<Expression>());
            var newExp = Expression.AndAlso(expression.Body, invokedExpr);
        ...
        /// 与
        /// </summary>
        public static Expression<Func<T1, T2, bool>> AndAll<T1, T2>(this Expression<Func<T1, T2, bool>> expression, Expression<Func<T1, T2, bool>> andExpression)
        {
            var invokedExpr = Expression.Invoke(andExpression, expression.Parameters.Cast<Expression>());
            var newExp = Expression.AndAlso(expression.Body, invokedExpr);
        ...
        /// 与
        /// </summary>
        public static Expression<Func<T1, T2, T3, bool>> AndAll<T1, T2, T3>(this Expression<Func<T1, T2, T3, bool>> expression, Expression<Func<T1, T2, T3, bool>> andExpression)
        {
            var invokedExpr = Expression.Invoke(andExpression, expression.Parameters.Cast<Expression>());
            var newExp = Expression.AndAlso(expression.Body, invokedExpr);
        ...
        /// 与
        /// </summary>
        public static Expression<Func<T1, T2, T3, T4, bool>> AndAll<T1, T2, T3, T4>(this Expression<Func<T1, T2, T3, T4, bool>> expression, Expression<Func<T1, T2, T3, T4, bool>> andExpression)
        {
            var invokedExpr = Expression.Invoke(andExpression, expression.Parameters.Cast<Expression>());
            var newExp = Expression.AndAlso(expression.Body, invokedExpr);
        ...
        /// 与
        /// </summary>
        public static Expression<Func<T1, T2, T3, T4, T5, bool>> AndAll<T1, T2, T3, T4, T5>(this Expression<Func<T1, T2, T3, T4, T5, bool>> expression, Expression<Func<T1, T2, T3, T4, T5, bool>> andExpression)
        {
            var invokedExpr = Expression.Invoke(andExpression, expression.Parameters.Cast<Expression>());
            var newExp = Expression.AndAlso(expression.Body, invokedExpr);
        ...
        /// 与
        /// </summary>
        public static Expression<Func<T1, T2, T3, T4, T5, T6, bool>> AndAll<T1, T2, T3, T4, T5, T6>(this Expression<Func<T1, T2, T3, T4, T5, T6, bool>> expression, Expression<Func<T1, T2, T3, T4, T5, T6, bool>> andExpression)
        {
            var invokedExpr = Expression.Invoke(andExpression, expression.Parameters.Cast<Expression>());
            var newExp = Expression.AndAlso(expression.Body, invokedExpr);
        ...
        /// 与
        /// </summary>
        public static Expression<Func<T1, T2, T3, T4, T5, T6, T7, bool>> AndAll<T1, T2, T3, T4, T5, T6, T7>(this Expression<Func<T1, T2, T3, T4, T5, T6, T7, bool>> expression, Expression<Func<T1, T2, T3, T4, T5, T6, T7, bool>> andExpression)
        {
            var invokedExpr = Expression.Invoke(andExpression, expression.Parameters.Cast<Expression>());
            var newExp = Expression.AndAlso(expression.Body, invokedExpr);
        ...
        /// 与
        /// </summary>
        public static Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, bool>> AndAll<T1, T2, T3, T4, T5, T6, T7, T8>(this Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, bool>> expression, Expression<Func<T1, T2, T3, T4, T5, T6, T7, T8, bool>> andExpression)
        {
            var invokedExpr = Expression.Invoke(andExpression, expression.Parameters.Cast<Expression>());
            var newExp = Expression.AndAlso(expression.Body, invokedExpr);
